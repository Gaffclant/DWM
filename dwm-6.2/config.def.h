...
static const char *fonts[]          = { "Angel Rhapsody:size=14:anitalias=true:autohint=true" };
static const char dmenufont[]       = "Angel Rhapsody:size=14:antialias=true:autohint=truev";
